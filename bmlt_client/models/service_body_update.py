...
class ServiceBodyUpdate(BaseModel):
    """
    ServiceBodyUpdate
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceBodyUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceBodyUpdate:
        """Create an instance of ServiceBodyUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceBodyUpdate.parse_obj(obj)

        _obj = ServiceBodyUpdate.parse_obj({
