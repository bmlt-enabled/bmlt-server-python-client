...
class TokenCredentials(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TokenCredentials:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TokenCredentials:
        """Create an instance of TokenCredentials from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TokenCredentials.parse_obj(obj)

        _obj = TokenCredentials.parse_obj({
