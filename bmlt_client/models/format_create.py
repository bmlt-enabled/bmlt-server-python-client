...
class FormatCreate(BaseModel):
    ...
    translations: conlist(FormatTranslation) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormatCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormatCreate:
        """Create an instance of FormatCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormatCreate.parse_obj(obj)

        _obj = FormatCreate.parse_obj({
