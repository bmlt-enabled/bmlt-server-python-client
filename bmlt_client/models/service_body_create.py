...
class ServiceBodyCreate(BaseModel):
    """
    ServiceBodyCreate
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceBodyCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceBodyCreate:
        """Create an instance of ServiceBodyCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceBodyCreate.parse_obj(obj)

        _obj = ServiceBodyCreate.parse_obj({
