...
class MeetingBase(BaseModel):
    ...
    MeetingBase
    """
    service_body_id: Optional[StrictInt] = Field(None, alias="serviceBodyId")
    format_ids: Optional[conlist(StrictInt)] = Field(None, alias="formatIds")
    venue_type: Optional[StrictInt] = Field(None, alias="venueType")
    temporarily_virtual: Optional[StrictBool] = Field(None, alias="temporarilyVirtual")
    day: Optional[StrictInt] = None
    start_time: Optional[StrictStr] = Field(None, alias="startTime")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeetingBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeetingBase:
        """Create an instance of MeetingBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MeetingBase.parse_obj(obj)

        _obj = MeetingBase.parse_obj({
