...
class RootServerApi:
    ...
    def update_settings(
        self,
        settings_update: Annotated[SettingsUpdate, Field(description="Pass in settings object with values to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param settings_update: Pass in settings object with values to update (required)
